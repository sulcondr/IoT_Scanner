...
\begin{thanks}
Za podporu a pomoc při psaní této práce bych chtěl poděkovat svému vedoucímu Ing. Pavlu Trollerovi. Dále bych chtěl poděkovat své rodině, která mi byla velkou oporou během celého studia i při psaní této práce. A na závěr bych chtěl říct své díky i mému kolegovi Bc. Jaraslovu Bartošovi za konzultace při návrhu a 3D tisk krytu v této práci použitému.  
\end{thanks}
