...
class lora_receive_realtime(gr.top_block):
    ...
    def __init__(self, target_freq, sf):
        ...
        self.osmosdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + 'rtl_tcp=localhost:7373' )
        ...
        self.lora_message_socket_sink_0 = lora.message_socket_sink('127.0.0.1', 5005, 3)
